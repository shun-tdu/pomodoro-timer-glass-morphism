    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                {/* 名前入力 */}
                <label className="text-white font-mono text-xl">
                    Subject Name :
                </label>
                <input
                    type="text"
            ...
            <div className="flex flex-col gap-4 items-center">
                <label className="text-white font-mono text-xl w-full">
                    Color :
                </label>
...
export function HumburgerMenu({
    ...
    const [isOpenAddSubjectModalOpen, setIsOpenAddSubjectModal] =
        useState(false);
